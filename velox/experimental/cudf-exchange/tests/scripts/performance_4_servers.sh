...
for block_size in "${block_sizes[@]}"; do
  ...
  CUDA_VISIBLE_DEVICES=5 \
    ...
    -v=3 --logtostdout -velox_cudf_memory_resource=pool \
    -cudfChunkSizeMB=${block_size} \
    -maxOutputBufferSizeMB=32768 >&server_2_bufSize_${block_size}.log &
  pid2=$!
  ...
  CUDA_VISIBLE_DEVICES=4 \
    ...
    -v=3 --logtostdout -velox_cudf_memory_resource=pool \
    -cudfChunkSizeMB=${block_size} \
    -maxOutputBufferSizeMB=32768 >&server_3_bufSize_${block_size}.log &
  pid3=$!
  ...
  CUDA_VISIBLE_DEVICES=3 \
    ...
    -v=3 --logtostdout -velox_cudf_memory_resource=pool \
    -cudfChunkSizeMB=${block_size} \
    -maxOutputBufferSizeMB=32768 >&server_4_bufSize_${block_size}.log &
  pid4=$!
  ...
  CUDA_VISIBLE_DEVICES=7 \
    ...
    $CLIENT \
    -v=3 --logtostdout -velox_cudf_memory_resource=pool \
    -nodes="http://sally:24356,http://sally:24357,http://sally:24358,http://sally:24359" >&client_bufSize_${block_size}.log &
  pid5=$!
