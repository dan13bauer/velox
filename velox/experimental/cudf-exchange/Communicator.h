...
class Communicator {
 ...
 public:
  ...
  static std::shared_ptr<Communicator> initAndGet(uint16_t port,uint16_t offset);
  ...
  /// task URL on the remote worker                                                                                                                                                                                                                            
  /// It is a hack but allows us not to have change the coordinator code                                                                                                                                                                                       
